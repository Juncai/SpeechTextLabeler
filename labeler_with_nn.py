...
# # build the continuous data set
# ds = SupervisedDataSet(3, 1)
# for i in range(len(l_data.data)):
#     ds.addSample(l_data.data[i], l_data.target[i])
# print ds['input']
# print ds['target']
...
for i in range(len(l_data.data)):
    ds.appendLinked(l_data.data[i], l_data.target[i])
...
print fnn.activateOnDataset(tstdata)
